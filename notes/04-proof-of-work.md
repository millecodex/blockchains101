...
> Figure: Degrees of decentralisation. The dots are nodes in the network and the graph edges are communication links. Source: See Baran (1964, link below) for an excellent overview of redundancy and vulnerability of digital communications networks.
